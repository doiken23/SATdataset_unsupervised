...
from sat_dataset_classification import SAT_Dataset
import autoencoder
...
def get_argument():
    ...
    parser.add_argument('--epochs', type=int, default=450, help='number of the epoch to train (default:450)')
    ...
    parser.add_argument('--milestones', type=list, default=[150, 300], help='epoch that reduce the learning rate (default:[150, 300])')
    parser.add_argument('embedding_dimension', type=int, default=100, help='dimension of embedded feature (default:100)')
...
def main(args):
    ...
    net = autoencoder.Large_AutoEncoder(c * h * w, args.embedding_dimension)
